...
class RobotContainer:
        ...
        self.m_robotDrive.setDefaultCommand(
            ...
            commands2.RunCommand(
                lambda: self.m_robotDrive.drive(
                    ...
                    self.m_driverController.getX(Constants.Hand.kRight) * Constants.ModuleConstants.kMaxModuleAngularSpeedRadiansPerSecond,
                    False
                ),
                self.m_robotDrive
            )
    ...
    def getAutonomousCommand(self):
        ...
        return commands2.Commands.sequence(
            commands2.InstantCommand(lambda: self.m_robotDrive.resetOdometry(example_trajectory.getInitialPose())),
