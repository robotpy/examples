...
class DriveSubsystem(commands2.SubsystemBase):
    ...
    def __init__(self) -> None:
        ...
        self.left_encoder.setDistancePerPulse(constants.DriveConstants.kEncoderDistancePerPulse)
        self.right_encoder.setDistancePerPulse(constants.DriveConstants.kEncoderDistancePerPulse)
