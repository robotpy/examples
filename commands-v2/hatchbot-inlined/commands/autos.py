...
class Autos():
    ...
    def simpleAuto(self, drive: subsystems.drivesubsystem.DriveSubsystem):
    ...
    def complexAuto(self, driveSubsystem: subsystems.drivesubsystem.DriveSubsystem, hatchSubsystem: subsystems.hatchsubsystem.HatchSubsystem):
        ...
        return commands2.cmd.sequence([
            ...
            commands2.FunctionalCommand(
                ...
                lambda interrupt: driveSubsystem.arcadeDrive(0,0),
                # End the command when the robot's driven distance exceeds the desired value
                lambda: driveSubsystem.getAverageEncoderDistance() <= constants.kAutoBackupDistanceInches,
                # Require the drive subsystem
                [driveSubsystem]
            )
        ])