...
class Drivetrain(SubsystemBase):
    def __init__(self):
        ...
        self.odometry = DifferentialDriveOdometry(self.gyro.getRotation2d(), self.leftEncoder.getDistance(), self.rightEncoder.getDistance())
    ...
    def resetOdometry(self, pose):
        ...
        self.resetEncoders()
        self.odometry.resetPosition(self.gyro.getRotation2d(), self.leftEncoder.getDistance(), self.rightEncoder.getDistance(), self.getPose())
