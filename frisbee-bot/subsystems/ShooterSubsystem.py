...
class ShooterSubsystem(commands2.PIDSubsystem):
    ...
    def ShooterSubsystemSetup(self):
        self.shooterMotor = wpilib.PWMSparkMax(constants.Constants.ShooterConstants.kShooterMotorPort)
        self.feederMotor = wpilib.PWMSparkMax(constants.Constants.ShooterConstants.kFeederMotorPort)
