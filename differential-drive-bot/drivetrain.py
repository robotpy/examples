...
class Drivetrain:
    ...
    def __init__(self):
        ...
        # resolution.
        self.leftEncoder.setDistancePerPulse(2 * math.pi * self.WHEEL_RADIUS / self.ENCODER_RESOLUTION)
    ...
    def setSpeeds(self, speeds: wpimath.kinematics.DifferentialDriveWheelSpeeds):
        ...
        leftOutput = self.leftPIDController.calculate(self.leftEncoder.getRate(), speeds.left)
        rightOutput = self.rightPIDController.calculate(self.rightEncoder.getRate(), speeds.right)
